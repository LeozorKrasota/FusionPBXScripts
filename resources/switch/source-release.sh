...
TOKEN=pat_jU1YJMjf13s443AePeNnGCWY
apt-get update && apt-get install -yq gnupg2 wget lsb-release
wget --http-user=Leozor --http-password=$TOKEN -O /usr/share/keyrings/signalwire-freeswitch-repo.gpg https://freeswitch.signalwire.com/repo/deb/debian-release/signalwire-freeswitch-repo.gpg
echo "machine freeswitch.signalwire.com login Leozor password $TOKEN" > /etc/apt/auth.conf
...
cd freeswitch
wget https://raw.githubusercontent.com/LeozorKrasota/Freeswitch1.2.7/main/modules.conf
