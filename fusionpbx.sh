...
#        echo "Install FusionPBX from master branch"
#	branch=""
#else
...
#        echo "Install FusionPBX from branch "${system_version}
...
branch="-b master"
git clone https://github.com/LeozorKrasota/fusionpbx.git /var/www/fusionpbx
